...
#        print m.patches # DEBUG
    ...
    # INSERT HACKED SECTION FOR CHINA LABELLED PLOT
    # THIS IS BAD AND YOU SHOULD FEEL BAD

    m.m.plot(102.5, 37., 'x', color='k')
    m.ax.text(103.,36.8, 'Pinggu', fontsize=5)
    m.m.plot(102.5, 36., '.', color='k')
    m.ax.text(103.,35.8, 'IAP Tower', fontsize=5)

    m.m.plot([105.,110.],[32., 32.], '|-', color='k')
    m.ax.text(104.8, 31., '5 degrees = 170 km', fontsize=5)
